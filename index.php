...
<body>
	...
	<table border="1" width="50%"> <!-- membuat tabel -->
		<tr>
			...
			<th>alamat_pegawai</th> <!-- membuat judul kolom -->
			<th>kode_pegawai</th> <!-- membuat judul kolom -->
			<th>nama_bagian</th> <!-- membuat judul kolom -->
		...
		$data = mysqli_query($conn,"select dp.*,bp.nama_bagian from data_pegawai dp, bagian_pegawai bp where dp.kode_bagian = bp.kode_bagian"); //membuat variabel data 
